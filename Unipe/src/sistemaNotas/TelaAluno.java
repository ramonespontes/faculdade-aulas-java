...
public class TelaAluno {
	...
	private void initialize() {
		...
		table.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "ALUNO", "TIPO", "NOTA1", "NOTA2", " NOTA3", "NOTA4", "M\u00C9DIA" }));
		scrollPane.setViewportView(table);

		JLabel lblNewLabel_1 = new JLabel("Tipo Aluno:");
		lblNewLabel_1.setBounds(10, 128, 77, 14);
		...
		lblNewLabel_3.setBounds(36, 171, 46, 14);
		frame.getContentPane().add(lblNewLabel_3);

		textFieldNotaUm = new JTextField();
		textFieldNotaUm.setBounds(40, 196, 36, 20);
...
//				//Calculo da média
				...
				tabela.addRow(new String[] { String.valueOf(media), "Especial", String.valueOf(nota1),
						String.valueOf(nota2), String.valueOf(nota3), String.valueOf(nota4), String.valueOf(media) });
